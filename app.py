...
# # File uploader for multiple PDF resumes
...
# # Function to summarize resume vs job
# def generate_summary_with_huggingface(job_desc, resume_text):
#     try:
...
#             summary = generate_summary_with_huggingface(job_description, resume_text)
